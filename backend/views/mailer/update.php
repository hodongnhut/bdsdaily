...
$this->title = 'Cập nhật Mailer: ' . $model->name;
...
<main class="flex-1 p-6 overflow-auto">
    <div class="bg-white p-6 rounded-lg shadow-md mb-6">
        <div class="mailer-config-update box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <?= Html::a('<i class="fa fa-list"></i> Danh sách', ['index'], ['class' => 'btn btn-success  btn-sm btn-flat']) ?>
                </div>
            </div>
