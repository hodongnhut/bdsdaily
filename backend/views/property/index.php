...
<header class="bg-white shadow-md p-2 flex items-center justify-between rounded-bl-lg">
    ...
    <div class="relative flex items-center space-x-4">
        <div class="flex space-x-2">
            <button id="openDialog" class="px-3 py-1.5 rounded-lg bg-indigo-600 hover:bg-red-700 text-white shadow-md flex items-center space-x-1.5 text-sm transition-colors duration-200">
        ...
        <button
            id="userMenuButton"
            class="w-10 h-10 bg-indigo-500 hover:bg-blue-600 text-white rounded-full flex items-center justify-center shadow-md transition-colors duration-200"
            aria-haspopup="true"
            aria-expanded="false">
...
<main class="flex-1 p-2 overflow-auto">
    ...
    $columns = [
        ...
        [
            ...
            'headerOptions' => ['class' => 'w-[90px] px-6 py-3 text-left text-xs capitalize font-medium text-gray-500 tracking-wider bg-yellow-500 hover:bg-yellow-600 text-white hidden md:table-cell'],
            'format' => 'raw',
            'value' => function ($model) {
