...
class SalesContactController extends Controller
{
    ...
    /**
     * Lists all SalesContact models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new SalesContactSearch();
    ...
    /**
     * Displays a single SalesContact model.
     * @param string $id ID
     * @return string
    ...
    /**
     * Creates a new SalesContact model.
    ...
    /**
     * Updates an existing SalesContact model.
    ...
    {
        if (($model = SalesContact::findOne(['id' => $id])) !== null) {
            return $model;
        }
